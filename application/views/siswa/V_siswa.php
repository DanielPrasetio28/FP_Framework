    ...
    <div class="flex" id="app">
        ...
        <div class="flex-1 p-8 space-y-6 transition-all duration-300" id="content">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="<?= site_url('siswa/tambah'); ?>" class="bg-blue-500 text-white p-3 rounded-md inline-block transform transition-transform duration-300 hover:scale-110 hover:bg-gradient-to-r from-blue-500 to-indigo-500">
