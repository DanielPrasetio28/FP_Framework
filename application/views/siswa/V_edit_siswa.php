...
<body class="bg-blue-50 font-sans">
    ...
    <div class="flex" id="app">
        <div class="bg-white text-gray-800 w-64 min-h-screen p-5 space-y-6">
            <ul class="space-y-4">
                <li><a href="<?= site_url('dashboard'); ?>" class="text-blue-500 flex items-center p-3 rounded-md text-2xl font-bold ml-4">SiFoAkademik</a></li>
                ...
                <li><a href="<?= site_url('guru'); ?>" class="flex items-center hover:bg-gradient-to-r from-blue-500 to-indigo-400 hover:text-white p-3 rounded-md"><i class="fas fa-chalkboard-teacher mr-3"></i>Pengelolaan Data Guru</a></li>
            </ul>
        </div>
        ...
        <div class="flex-1 p-8 space-y-6">
            ...
            <form action="<?= site_url('siswa/update/' . $siswa->nisn); ?>" method="POST">
                <div class="space-y-4">
                    ...
                    <button type="submit" class="bg-blue-500 text-white p-3 rounded-md inline-block transform transition-transform duration-300 hover:scale-110 hover:bg-gradient-to-r from-blue-500 to-indigo-500">Simpan Perubahan</button>
                </div>
            </form>
